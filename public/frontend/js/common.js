...
function menu(btnClick) {
    ...
    $(btnClick).click(function () {
        ...
        if (click == 0) {
            ...
            $(this).css({'background': '#4cbc5f url("http://shop.duoclieutuelinh.vn/frontend/images/menu-close.png")'});
            click++;
        } else {
            $(menu).removeClass('transX0');
            $(this).css({'background': '#4cbc5f url("http://shop.duoclieutuelinh.vn/frontend/images/menu-open.png")'});
            click--;
        }
    });
}
